...
public class OosAboutPreference extends BasePreferenceController implements View.OnTouchListener {
    ...
    public void onBindItems(View holder) {
        ...
        TextView display = null, cpu = null, battery = null, soc = null, cam = null,
                device, deviceSec, flareVer, flareStatus,
        ...
        maintainer = root.findViewById(R.id.flare_maintainer);
        flareVer = root.findViewById(R.id.flareVer);
	flareStatus = root.findViewById(R.id.flareStatus);
	...
	flareStatus.setText(String.format(" Project Flare %s", SystemProperties.get("ro.lineage.build.version")));
        setInfo("ro.lineage.build.version", flareVer);
        setInfo("ro.lineage.maintainer", maintainer);
